      ...
      <header class="welcome-header">
        <div class="title-row">
          <div class="logo-wrapper">
            ...
            <img src="@/assets/image/logo.png" alt="桥载千秋" class="logo-img" />
          </div>
...
.welcome-container.leaving {
  ...
  .welcome-content {
    animation: contentFadeOut 0.5s ease-in-out forwards;
  }
  
  .ink-bg {
    animation: bgZoomOut 0.6s ease-in-out forwards;
  }
}
