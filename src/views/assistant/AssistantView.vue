...
import assistantAvatar from '@/assets/images/icons/assistant-avatar.svg'
...
const getBridgeImage = (name) => {
  const imageMap = {
    '赵州桥': new URL('../../assets/images/bridges/zhaozhou-bridge.png', import.meta.url).href,
    '卢沟桥': new URL('../../assets/images/bridges/lugou-bridge.png', import.meta.url).href,
    '洛阳桥': new URL('../../assets/images/bridges/luoyang-bridge.png', import.meta.url).href,
    '安平桥': new URL('../../assets/images/bridges/anping-bridge.png', import.meta.url).href,
    '广济桥': new URL('../../assets/images/bridges/guangji-bridge.png', import.meta.url).href,
    '泸定桥': new URL('../../assets/images/bridges/luding-bridge.png', import.meta.url).href,
    '五亭桥': new URL('../../assets/images/bridges/wuting-bridge.png', import.meta.url).href,
    '十七孔桥': new URL('../../assets/images/bridges/shiqikong-bridge.png', import.meta.url).href,
    '宝带桥': new URL('../../assets/images/bridges/baodai-bridge.png', import.meta.url).href,
    '放生桥': new URL('../../assets/images/bridges/fangsheng-bridge.png', import.meta.url).href,
    '盘江桥': new URL('../../assets/images/bridges/panjiang-bridge.png', import.meta.url).href,
    '程阳永济桥': new URL('../../assets/images/bridges/chengyang-bridge.png', import.meta.url).href,
    '霁虹桥': new URL('../../assets/images/bridges/jihong-bridge.png', import.meta.url).href,
    '风雨桥': new URL('../../assets/images/bridges/fengyu-bridge.png', import.meta.url).href,
    '鱼沼飞梁': new URL('../../assets/images/bridges/yuzhao-bridge.png', import.meta.url).href
  }
  return imageMap[name] || new URL('../../assets/images/bridges/zhaozhou-bridge.png', import.meta.url).href
}
...
const getGuideContent = () => {
  ...
  const steps = [
    ...
    {
      title: '建筑特色',
      content: `${bridge.name}是一座${bridge.bridgeType}，采用${bridge.material}质建造。主跨${bridge.span}米，全长${bridge.length}米，宽${bridge.width}米。${bridge.features && bridge.features.length > 0 ? '主要特点包括：' + bridge.features.join('、') + '。' : ''}`,
      image: getBridgeImage(bridge.name)
    },
    {
      title: '文化价值',
  ...
  try {
    ...
    const startDisplayTimer = () => {
      ...
      displayTimer = setInterval(() => {
        if (assistantMessageIndex >= 0 && displayedLength < textBuffer.length) {
          const charsToAdd = Math.min(2, textBuffer.length - displayedLength)
          displayedLength += charsToAdd
          messages.value[assistantMessageIndex].content = textBuffer.substring(0, displayedLength)
          scrollToBottom()
        }
      }, 25)
    }
    ...
    ws.onmessage = (event) => {
      try {
        ...
        if (data.header && data.header.status === 2) {
          stopDisplayTimer()
          if (assistantMessageIndex >= 0) {
            messages.value[assistantMessageIndex].content = textBuffer
            messages.value[assistantMessageIndex].isStreaming = false
            messages.value[assistantMessageIndex].time = getCurrentTime()
