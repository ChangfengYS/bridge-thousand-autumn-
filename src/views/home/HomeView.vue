  ...
  <div class="main-wrapper">
    <header class="top-header">
      <div class="header-left">
        <div class="logo">
          <img src="@/assets/images/logo/logo.png" alt="桥载千秋" class="logo-icon" />
          <div class="logo-text">
            <h1>桥载千秋・形映山河</h1>
...
import bgmMp3 from '@/assets/media/bgm.mp3'
...
.header-center {
  ...
  .nav-item {
    ...
    font-size: 17px;
    font-weight: 600;
    font-family: 'Noto Serif SC', 'Source Han Serif SC', 'Source Han Serif CN', 'Microsoft YaHei', 'STKaiti', 'KaiTi', 'PingFang SC', 'Hiragino Sans GB', 'SimSun', serif;
    white-space: nowrap;
    position: relative;
